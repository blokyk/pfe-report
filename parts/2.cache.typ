...
Dans l'exemple qui nous intéresse, si un coeur charge une ligne de cache et sait qu'il va ensuite la modifier, les conséquences de la lecture _et_ de l'écriture peuvent être gérées d'un coup par le protocole plus efficacement qu'une lecture et une écriture séparément.
