...
De façon générale, compiler gem5 ou LLVM sur mon ordinateur de travail étant impensable. Même sur le serveur de build dédié du laboratoire, la compilation de gem5 prend 1h initialement et 10min à chaque itération après modification du code source ; de même, LLVM prend plus d'1h à froid avec des itérations entre quelques secondes et quelques minutes selon les fichiers modifiés. Et bien sûr, changer les paramètres de builds demandent généralement de recompiler à froid. Trouver les bons paramètres sans expertise préalable est donc un investissement chronophage qu'il est désirable de ne faire qu'une fois.
